...
import 'package:flutter_application_1/screens/poster.dart';
...
import 'PendingWithdrawals.dart';
...
class _MenuDashboardPageState extends State<MenuDashboardPage>
  ...
  void navigateToNextPage() {
    ...
    Future.delayed(Duration(seconds: 2), () {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => poster()),
      );
    }).then((value) {
      setState(() {
        isLoading = false;
                            ...
                            SizedBox(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: AssetImage(
                                          'assets/assets/displayPicture.png')),
                                ),
                              ),
                            ),
                          ],
              ...
              ListTile(
                ...
                onTap: () => {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => withdraw(token: token)))
                },
              ),
              SizedBox(
                height: 20,
                              ...
                              FutureBuilder<UserInfo>(
                                  ...
                                  builder: (context, snapshot) {
                                    if (snapshot.hasError) {
                                      ...
                                      var currentLoanIndex =
                                          snapshot.data!.loan.length - 1;
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            SizedBox(height: 16),
            if (isLoading) CircularProgressIndicator(), // Loading spinner
          ],
        ),
        ...
        children: <Widget>[
          DrawerHeader(
            child: Column(children: <Widget>[
              CircleAvatar(
                backgroundImage: AssetImage('assets/displayPicture.png'),
                backgroundColor: Colors.greenAccent,
                radius: 50,
              ),
                ...
                child: FutureBuilder<UserInfo>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasError) {
                        ...
                        var userName =
                            snapshot.data!.user.username.toUpperCase();
          ...
          FutureBuilder<UserInfo>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasError) {
                  ...
                  var usertype = snapshot.data!.user.usertype.toUpperCase();
          ...
          //         return Text('${snapshot.error}');
          //       } else if (snapshot.hasData) {
          //         var usertype = snapshot.data!.user.usertype.toString();
                                ...
                                actions: [
                                  ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        var response=await AuthService().callForMoneyCreation(userID,amount,time,context);
              ...
              builder: (context, snapshot) {
                if (snapshot.hasError) {
                  ...
                  if (usertype == 'agent') {
                    return ListTile(
                      leading: Icon(Icons.change_circle_outlined),
                      title: Text('Pending Withdrawals'),
                      onTap: () => {
